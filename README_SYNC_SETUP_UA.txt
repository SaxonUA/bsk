...
---------------------
URL Google Apps Script уже вбудований безпосередньо у код. Додатково налаштовувати запис у головному браузері не потрібно.

ОНОВЛЕННЯ V10:
- У публічному OBS-віджеті постійно показуються сформовані взводи за турами.
- Поточний незавершений взвод відображається як «Формується».
- Для оновлення на GitHub достатньо замінити index.html, sync-wheel.js та platoon_cup_wheel.html.
